...
KUchive는 고려대학교 비교과 프로그램 플랫폼 **‘쿠카이브’**를 보다 효율적으로 활용하기 위해 제작한 자동화 기반 정보 관리 프로젝트이다.
...
본 프로젝트는 이러한 **수동 모니터링 비용과 정보 가독성 문제**를 해결하는 것을 목표로 한다.

---

## 진행 방식 및 구현 구조

본 시스템은 별도의 프론트엔드 개발 없이, 자동화와 API 연동을 중심으로 구성되었다.
...
본 프로젝트는 고려대학교 Student Success Center 주관  
**제5회 쿠카이브 공모전**에서 **우수상**을 수상하였다.

기존 수상작들이 사용법 안내 영상이나 카드뉴스 형태에 집중한 것과 달리,  
본 작품은 **실제 사용 가능한 자동화 시스템을 구현**했다는 점에서 차별성을 인정받았다.

![제5회 쿠카이브 공모전 수상](assets/award.png)
...
> 비교과 프로그램을 “확인해야 하는 정보”에서  
> “자동으로 전달되는 정보”로 전환하는 것을 목표로 한 자동화 프로젝트
